  ...
  var speechCommand = function(command, options){
    ...
    if(command){
      ...
      function updateHeight(){
        ...
        setTimeout(function(){UpdateJqgrid();}, 100);
      }
...
/* Grid */
  ...
  function nuevoAncho(lista)
  {
     anchin = $(window).width() - $("#cl-wrapper .menu-space").width() - 130;
     $("#"+lista).jqGrid( 'setGridWidth', anchin);
    ...
    $(window).on('resize.jqGrid',function()
    {
      ...
      if($(window).width() >= 780){
          ...
          anchinx =$(window).width() - 30;
          $("#"+lista).jqGrid( 'setGridWidth', anchinx);
      }
    });
  }
