(function (f, a, c, g, e) {
    ...
    function d(i) {
        i.html('<div class="plupload_wrapper"><div class="ui-widget-content plupload_container"><div class="plupload"><div class="ui-state-default ui-widget-header plupload_header"><div class="plupload_header_content"><div class="plupload_header_title">' + b("Seleccione archivos") + '</div><div class="plupload_header_text">' + b("Agrega los archivos a cargar y luego dar click en empezar carga.") + '</div></div></div><div class="plupload_content"><table class="plupload_filelist"><tr class="ui-widget-header plupload_filelist_header"><td class="plupload_cell plupload_file_name">' + b("Nombre de Archivo") + '</td><td class="plupload_cell plupload_file_status">' + b("Estado") + '</td><td class="plupload_cell plupload_file_size">' + b("Tama" + String.fromCharCode(241) + "o") + '</td><td class="plupload_cell plupload_file_action">&nbsp;</td></tr></table><div class="plupload_scroll"><table class="plupload_filelist_content"></table></div><table class="plupload_filelist"><tr class="ui-widget-header ui-widget-content plupload_filelist_footer"><td class="plupload_cell plupload_file_name"><div class="plupload_buttons"><!-- Visible --><a class="plupload_button plupload_add">' + b("Agregar Archivos") + '</a>&nbsp;<a class="plupload_button plupload_start">' + b("Empezar Carga") + '</a>&nbsp;<a class="plupload_button plupload_stop plupload_hidden">' + b("Para Carga") + '</a>&nbsp;</div><div class="plupload_started plupload_hidden"><!-- Hidden --><div class="plupload_progress plupload_right"><div class="plupload_progress_container"></div></div><div class="plupload_cell plupload_upload_status"></div><div class="plupload_clearer">&nbsp;</div></div></td><td class="plupload_file_status"><span class="plupload_total_status">0%</span></td><td class="plupload_file_size"><span class="plupload_total_file_size">0 kb</span></td><td class="plupload_file_action"></td></tr></table></div></div></div><input class="plupload_count" value="0" type="hidden"></div>')
    }
    g.widget("ui.plupload", {
                ...
                j.bind("FilesAdded", function (l, n) {
                    ...
                    if (p > 0) {
                        ...
                        l.trigger("Error", {
                            ...
                            message: b("N" + String.fromCharCode(250) + "mero de archivos err" + String.fromCharCode(243) + "neo."),
                            file: o
                        })
                    }
                })
                    ...
                    if (m) {
                        ...
                        switch (p.code) {
                            ...
                            case c.FILE_SIZE_ERROR:
                                m = b("Archivo: %f, tama" + String.fromCharCode(241) + "o: %s, tama" + String.fromCharCode(241) + "o max. archivo: %m").replace(/%([fsm])/g, function (r, q) {
                                    switch (q) {
                                        case "f":
                                            return n.name;
                                        case "s":
                            ...
                            case i.FILE_COUNT_ERROR:
                                m = b("Solo se puede cargar %d archivo(s).").replace("%d", i.options.max_file_count);
                                break;
        ...
        _handleState: function () {
            ...
            if (j.state === c.STARTED) {
                ...
                g(".plupload_upload_status", i.element).text(b("Cargados %d/%d archivos").replace("%d/%d", j.total.uploaded + "/" + j.files.length));
        ...
        _updateFileList: function () {
            ...
            if (n.total.queued === 0) {
                ...
                g(".ui-button-text", j.browse_button).text(b("%d archivos en cola").replace("%d", n.total.queued))
            }
        ...
        _enableRenaming: function () {
            var i = this;
            g(".plupload_file_name span", this.filelist).on("click", function (o) {
                var m = g(o.target),
                    k, n, j, l = "";
        ...
        destroy: function () {
            ...
            if (g.ui.sortable && this.options.sortable) {
                g('tbody.ui-sortable', this.filelist).sortable('destroy'); 
            }
